...
# 1. Puxa as informações escondidas do arquivo .env
load_dotenv()
...
# Monta a URL de conexão com os dados blindados
URL_BANCO = f"postgresql://{DB_USER}:{DB_PASS}@{DB_HOST}:{DB_PORT}/{DB_NAME}"

# 2. A Base e a configuração
